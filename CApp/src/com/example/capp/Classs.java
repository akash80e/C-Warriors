...
public class Classs extends SQLiteOpenHelper
	
	{
		SQLiteDatabase db,databaseobject;
		static int DBVERSION=1;
		static String DBNAME="projectdatabase";
		Context mycontext;
		String DBPATH="/data/data/com.example.capp/databases/";
